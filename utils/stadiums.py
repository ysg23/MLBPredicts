...
STADIUMS = [
    ...
    {"stadium_id": 20, "name": "Oakland Coliseum", "team_abbr": "OAK", "city": "Oakland", "state": "CA", "latitude": 37.7516, "longitude": -122.2005, "elevation_ft": 3, "roof_type": "open", "lf_distance": 330, "cf_distance": 400, "rf_distance": 330, "hr_park_factor": 0.86},
...
def load_stadiums_to_db():
    ...
    count = upsert_many("stadiums", STADIUMS)
