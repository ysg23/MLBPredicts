...
CREATE TABLE IF NOT EXISTS mlb_park_factors (
    ...
    stadium_id BIGINT REFERENCES mlb_stadiums(stadium_id),
...
CREATE TABLE IF NOT EXISTS mlb_weather (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    game_id BIGINT REFERENCES mlb_games(game_id),
...
CREATE INDEX IF NOT EXISTS idx_mlb_weather_game ON mlb_weather(game_id);

CREATE TABLE IF NOT EXISTS mlb_lineups (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    game_date DATE NOT NULL,
    game_id BIGINT NOT NULL REFERENCES mlb_games(game_id),
...
CREATE INDEX IF NOT EXISTS idx_mlb_batter_stats_player ON mlb_batter_stats(player_id, stat_date);
CREATE INDEX IF NOT EXISTS idx_mlb_batter_stats_date ON mlb_batter_stats(stat_date);
...
CREATE INDEX IF NOT EXISTS idx_mlb_pitcher_stats_player ON mlb_pitcher_stats(player_id, stat_date);
CREATE INDEX IF NOT EXISTS idx_mlb_pitcher_stats_date ON mlb_pitcher_stats(stat_date);
...
CREATE INDEX IF NOT EXISTS idx_mlb_hr_odds_game ON mlb_hr_odds(game_date, player_id);
...
CREATE INDEX IF NOT EXISTS idx_mlb_hr_model_scores_date ON mlb_hr_model_scores(game_date);
CREATE INDEX IF NOT EXISTS idx_mlb_hr_model_scores_signal ON mlb_hr_model_scores(signal);
...
CREATE INDEX IF NOT EXISTS idx_mlb_market_odds_lookup
ON mlb_market_odds(market, game_id, player_id, team_abbr, bet_type, fetched_at);
...
CREATE INDEX IF NOT EXISTS idx_mlb_market_odds_selection_key ON mlb_market_odds(selection_key);
...
CREATE TABLE IF NOT EXISTS mlb_model_scores (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    score_run_id BIGINT REFERENCES mlb_score_runs(id),
    market TEXT NOT NULL,
    game_id BIGINT NOT NULL REFERENCES mlb_games(game_id),
    game_date DATE NOT NULL,
    event_id TEXT,
...
CREATE INDEX IF NOT EXISTS idx_mlb_model_scores_date_market
ON mlb_model_scores(game_date, market, signal, model_score);
...
CREATE INDEX IF NOT EXISTS idx_mlb_bets_date ON mlb_bets(game_date);
CREATE INDEX IF NOT EXISTS idx_mlb_bets_result ON mlb_bets(result);
...
CREATE INDEX IF NOT EXISTS idx_mlb_closing_lines_date_market ON mlb_closing_lines(game_date, market);
CREATE INDEX IF NOT EXISTS idx_mlb_closing_lines_selection_key ON mlb_closing_lines(selection_key);
