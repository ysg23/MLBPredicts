...
ALTER TABLE market_odds ADD COLUMN IF NOT EXISTS game_date DATE;
ALTER TABLE market_odds ADD COLUMN IF NOT EXISTS event_id TEXT;
ALTER TABLE market_odds ADD COLUMN IF NOT EXISTS entity_type TEXT;
ALTER TABLE market_odds ADD COLUMN IF NOT EXISTS team_id TEXT;
ALTER TABLE market_odds ADD COLUMN IF NOT EXISTS opponent_team_id TEXT;
ALTER TABLE market_odds ADD COLUMN IF NOT EXISTS selection_key TEXT;
ALTER TABLE market_odds ADD COLUMN IF NOT EXISTS side TEXT;
ALTER TABLE market_odds ADD COLUMN IF NOT EXISTS price_american INTEGER;
ALTER TABLE market_odds ADD COLUMN IF NOT EXISTS price_decimal DOUBLE PRECISION;
ALTER TABLE market_odds ADD COLUMN IF NOT EXISTS implied_probability DOUBLE PRECISION;
ALTER TABLE market_odds ADD COLUMN IF NOT EXISTS source_market_key TEXT;
ALTER TABLE market_odds ADD COLUMN IF NOT EXISTS is_best_available SMALLINT DEFAULT 0;
ALTER TABLE market_odds ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ;
ALTER TABLE market_odds ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ;

ALTER TABLE market_outcomes ADD COLUMN IF NOT EXISTS game_date DATE;
ALTER TABLE market_outcomes ADD COLUMN IF NOT EXISTS event_id TEXT;
ALTER TABLE market_outcomes ADD COLUMN IF NOT EXISTS entity_type TEXT;
ALTER TABLE market_outcomes ADD COLUMN IF NOT EXISTS team_id TEXT;
ALTER TABLE market_outcomes ADD COLUMN IF NOT EXISTS opponent_team_id TEXT;
ALTER TABLE market_outcomes ADD COLUMN IF NOT EXISTS selection_key TEXT;
ALTER TABLE market_outcomes ADD COLUMN IF NOT EXISTS side TEXT;
ALTER TABLE market_outcomes ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ;
ALTER TABLE market_outcomes ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ;

ALTER TABLE model_scores ADD COLUMN IF NOT EXISTS score_run_id BIGINT;
ALTER TABLE model_scores ADD COLUMN IF NOT EXISTS event_id TEXT;
ALTER TABLE model_scores ADD COLUMN IF NOT EXISTS entity_type TEXT;
ALTER TABLE model_scores ADD COLUMN IF NOT EXISTS team_id TEXT;
ALTER TABLE model_scores ADD COLUMN IF NOT EXISTS opponent_team_id TEXT;
ALTER TABLE model_scores ADD COLUMN IF NOT EXISTS selection_key TEXT;
ALTER TABLE model_scores ADD COLUMN IF NOT EXISTS side TEXT;
ALTER TABLE model_scores ADD COLUMN IF NOT EXISTS confidence_band TEXT;
ALTER TABLE model_scores ADD COLUMN IF NOT EXISTS reasons_json TEXT;
ALTER TABLE model_scores ADD COLUMN IF NOT EXISTS risk_flags_json TEXT;
ALTER TABLE model_scores ADD COLUMN IF NOT EXISTS lineup_confirmed SMALLINT;
ALTER TABLE model_scores ADD COLUMN IF NOT EXISTS weather_final SMALLINT;
ALTER TABLE model_scores ADD COLUMN IF NOT EXISTS is_active SMALLINT DEFAULT 1;
ALTER TABLE model_scores ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ;

ALTER TABLE bets ADD COLUMN IF NOT EXISTS market TEXT DEFAULT 'HR';
ALTER TABLE bets ADD COLUMN IF NOT EXISTS team_id TEXT;
ALTER TABLE bets ADD COLUMN IF NOT EXISTS opponent_team_id TEXT;
...
ALTER TABLE bets ADD COLUMN IF NOT EXISTS odds_close INTEGER;
ALTER TABLE bets ADD COLUMN IF NOT EXISTS implied_prob_open DOUBLE PRECISION;
ALTER TABLE bets ADD COLUMN IF NOT EXISTS implied_prob_close DOUBLE PRECISION;
ALTER TABLE bets ADD COLUMN IF NOT EXISTS clv_open_to_close DOUBLE PRECISION;
ALTER TABLE bets ADD COLUMN IF NOT EXISTS line_delta DOUBLE PRECISION;
