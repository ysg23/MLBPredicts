...
# ── Multi-market configs (initial defaults) ───────────────────────────────
# These are starting-point weights; tune via backtesting once outcomes/odds are wired.

K_FACTOR_WEIGHTS = {
    "k_form_score": 0.35,
    "whiff_chase_score": 0.25,
    "pitch_count_role_score": 0.20,
    "contact_quality_score": 0.10,  # lower contact quality can boost Ks slightly
    "context_score": 0.10,          # weather, umpire (if/when added)
}

MARKET_CONFIGS = {
    "HR": {"weights": HR_FACTOR_WEIGHTS, "thresholds": SIGNAL_THRESHOLDS},
    "K":  {"weights": K_FACTOR_WEIGHTS,  "thresholds": SIGNAL_THRESHOLDS},
}
